...
**[一个基于 Vue 3 + Vite + Vanilla CSS 构建的 学术研究辅助 微应用，具备深色玻璃拟态自适应交互与微信端 H5 体验]**

[Vue 3] · [TypeScript] · [Vite] · [Vanilla CSS] · [开源协议 MIT]

[![GitHub stars](https://img.shields.io/github/stars/WT-Agent/ai-xueshu?style=social)](https://github.com/WT-Agent/ai-xueshu)
[![GitHub license](https://img.shields.io/github/license/WT-Agent/ai-xueshu)](https://github.com/WT-Agent/ai-xueshu/blob/main/LICENSE)
...
### 1. 克隆项目
```bash
git clone https://github.com/WT-Agent/ai-xueshu.git
cd ai-xueshu
```
...
- GitHub Issues: [提交反馈](https://github.com/WT-Agent/ai-xueshu/issues)
- 邮箱: us@wuxian.xyz
